...
class RouterTests(unittest.TestCase):
    ...
    def test_router_succeeds_when_source_and_sink_are_immediately_reachable(self) -> None:
        ...
        self.assertEqual("bidirectional", result.route_plan.steps[0].new_edge_traversal_mode)
    ...
    def test_router_can_attach_source_and_sink_nodes_through_adjacent_junctions(self) -> None:
        ...
        self.assertTrue(
            all(step.new_edge_traversal_mode == "bidirectional" for step in result.route_plan.steps)
        )
